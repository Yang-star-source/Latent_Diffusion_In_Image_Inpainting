...
![Inpainting Flowchart](gif/inpainting1.png)
...
I built a repo that describe how to build Unconditional Image Generation , Latent Diffusion from scratch , the Latent Diffusion used for this repo is using the exact same weights.
...
### Video
* [Inpainting Explanation](https://www.youtube.com/watch?si=lAPbpanbzxL-Uv31&v=RwgzDtmSC5g&feature=youtu.be) (Intelligent Machines) - Insightful video
